...
class osapiPartuzaProvider extends osapiProvider {
  public function __construct(osapiHttpProvider $httpProvider = null,$url) {
    parent::__construct($url['requestTokenUrl'], $url['authorizeUrl'], $url['accessTokenUrl'], $url['restEndpoint'], $url['rpcEndpoint'], "Partuza", true, $httpProvider);
  }
}
