...
class XiaoiRestClient {
  ...
  public function __construct($api_key, $secret, $session_key=null) {
    ...
    $this->batch_mode = XiaoiRestClient::BATCH_MODE_DEFAULT;
    $this->last_call_id = 0;
    $this->call_as_apikey = '';
    $this->use_curl_if_available = true;
    $this->server_addr  = Xiaoi::get_xiaoi_url('api') . '/apiserver/rest.do';
	$this->server_addr_pay = Xiaoi::get_xiaoi_url('happy') . '/payQueryOrder.do';//"http://218.80.240.250:9988/payQueryOrder.do";//
    if (!empty($GLOBALS['xiaoi_config']['debug'])) {
      $this->cur_id = 0;
      ?>
...
<?php
  ...
  public function begin_batch() {
    if($this->batch_queue !== null) {
      $code = XiaoiAPIErrorCodes::API_EC_BATCH_ALREADY_STARTED;
      $description = XiaoiAPIErrorCodes::$api_error_descriptions[$code];
      throw new XiaoiRestClientException($description, $code);
    }
  ...
  public function end_batch() {
    if($this->batch_queue === null) {
      $code = XiaoiAPIErrorCodes::API_EC_BATCH_NOT_STARTED;
      $description = XiaoiAPIErrorCodes::$api_error_descriptions[$code];
      throw new XiaoiRestClientException($description, $code);
    }
  ...
  private function execute_server_side_batch() {
    ...
    $serial_only =
      ($this->batch_mode == XiaoiRestClient::BATCH_MODE_SERIAL_ONLY);
    ...
    if (is_array($result) && isset($result['error_code'])) {
      throw new XiaoiRestClientException($result['error_msg'],
                                            $result['error_code']);
    }
    ...
    for($i = 0; $i < $item_count; $i++) {
      ...
      if (is_array($batch_item_result) &&
        ...
        throw new XiaoiRestClientException($batch_item_result['error_msg'],
  ...
  public function application_getPublicInfo($application_id=null,
    ...
    return $this->call_method('application.getPublicInfo',
   ...
   * http://wiki.developers.xiaoi.com/index.php/Auth.createToken.
   *
   * @return string  An authentication token.
   */
  public function auth_createToken() {
    return $this->call_method('auth.createToken', array());
  }
  ...
  public function auth_getSession($auth_token, $generate_session_secret=false) {
    ...
    if($this->batch_queue === null) {
      $result = $this->call_method('auth.getSession',
  ...
  public function auth_promoteSession() {
      return $this->call_method('auth.promoteSession', array());
  }
  ...
  public function auth_expireSession() {
      return $this->call_method('auth.expireSession', array());
  }

  /**
   * Revokes the user's agreement to the Xiaoi Terms of Service for your
  ...
  public function auth_revokeAuthorization($uid=null) {
      return $this->call_method('auth.revokeAuthorization',
          array('uid' => $uid));
  }
  ...
  public function connect_getUnconnectedFriendsCount() {
    return $this->call_method('connect.getUnconnectedFriendsCount',
        array());
  }

 /**
  * This method is used to create an association between an external user
  * account and a Xiaoi user account, as per Xiaoi Connect.
  *
  ...
  *
  * This is designed to help Xiaoi Connect recognize when two Xiaoi
  ...
  *
  *   http://wiki.developers.xiaoi.com/index.php/Connect.registerUsers
  *
  ...
  */
  public function connect_registerUsers($accounts) {
    return $this->call_method('connect.registerUsers',
  ...
  */
  public function connect_unregisterUsers($email_hashes) {
    return $this->call_method('connect.unregisterUsers',
  ...
  public function &events_get($uid=null,
                              ...
                              $end_time=null,
                              $rsvp_status=null) {
    return $this->call_method('events.get',
        array('uid' => $uid,
              'eids' => $eids,
  ...
  public function &events_getMembers($eid) {
    return $this->call_method('events.getMembers',
      array('eid' => $eid));
  }
  ...
  public function &events_rsvp($eid, $rsvp_status) {
    return $this->call_method('events.rsvp',
        array(
        'eid' => $eid,
        'rsvp_status' => $rsvp_status));
  }
  ...
  public function &events_cancel($eid, $cancel_message='') {
    return $this->call_method('events.cancel',
        array('eid' => $eid,
  ...
  public function &events_create($event_info) {
    return $this->call_method('events.create',
  ...
  public function &events_edit($eid, $event_info) {
    return $this->call_method('events.edit',
        array('eid' => $eid,
  ...
  public function &fbml_refreshImgSrc($url) {
    return $this->call_method('fbml.refreshImgSrc',
        array('url' => $url));
  }
  ...
  public function &fbml_refreshRefUrl($url) {
    return $this->call_method('fbml.refreshRefUrl',
        array('url' => $url));
  }

  /**
   * Lets you insert text strings in their native language into the Xiaoi
  ...
  public function &fbml_uploadNativeStrings($native_strings) {
    return $this->call_method('fbml.uploadNativeStrings',
  ...
  public function &fbml_setRefHandle($handle, $fbml) {
    return $this->call_method('fbml.setRefHandle',
   ...
   *
   * http://wiki.developers.xiaoi.com/index.php/Fbml.RegisterCustomTags
   *
  ...
  public function &fbml_registerCustomTags($tags) {
    ...
    return $this->call_method('fbml.registerCustomTags',
                              array('tags' => $tags));
  }
  ...
  public function &fbml_getCustomTags($app_id = null) {
    return $this->call_method('fbml.getCustomTags',
                              array('app_id' => $app_id));
  }
  ...
  public function &fbml_deleteCustomTags($tag_names = null) {
    return $this->call_method('fbml.deleteCustomTags',
   ...
   * works only for publishing stories on a Xiaoi Page that has installed
   ...
   *
   * http://wiki.developers.xiaoi.com/index.php/Feed.publishTemplatizedAction
   */
  public function &feed_publishTemplatizedAction($title_template,
                                                 ...
                                                 $target_ids='',
                                                 $page_actor_id=null) {
    return $this->call_method('feed.publishTemplatizedAction',
   ...
   *
   *  http://wiki.developers.xiaoi.com/index.php/Feed.registerTemplateBundle
   *
  ...
  public function &feed_registerTemplateBundle($one_line_story_templates,
    ...
    return $this->call_method('feed.registerTemplateBundle',
  ...
  public function &feed_getRegisteredTemplateBundles() {
    return $this->call_method('feed.getRegisteredTemplateBundles',
        array());
  }
  ...
  public function &feed_getRegisteredTemplateBundleByID($template_bundle_id) {
    return $this->call_method('feed.getRegisteredTemplateBundleByID',
  ...
  public function &feed_deactivateTemplateBundleByID($template_bundle_id) {
    return $this->call_method('feed.deactivateTemplateBundleByID',
        array('template_bundle_id' => $template_bundle_id));
  }
   ...
   *
   *  http://wiki.developers.xiaoi.com/index.php/Feed.publishUserAction
   *
  ...
  public function &feed_publishUserAction(
      $uid,$template_name,$template_bundle_id, $template_data) {
...
//    }
    ...
    return $this->call_method('feed.publishUserAction',
        array('uid' => $uid,
        	  'templateName' => $template_name,
        	  'componentTargetId' => $template_bundle_id,
  ...
  public function &feed_getAppFriendStories() {
    return $this->call_method('feed.getAppFriendStories', array('server_addr'=>$this->server_addr));
  }
   ...
   * info at http://developers.xiaoi.com/documentation.php?v=1.0&doc=fql
   *
  ...
  public function &fql_query($query) {
    return $this->call_method('fql.query',
      array('query' => $query,'server_addr'=>$this->server_addr));
  }
/**
 * 返回交易是否成功
 */
  
  public function &pay_info($pid,$appid){
  	return $this->call_method('pay.info',
  	array('pid'=>$pid,'appid'=>$appid,'server_addr'=>$this->server_addr_pay)
  	);
  }
   ...
   * Note that the Xiaoi friend relationship is symmetric.
   *
  ...
  public function &friends_areFriends($uids1, $uids2) {
    return $this->call_method('friends.areFriends',
        array('uids1' => $uids1, 'uids2' => $uids2,'server_addr'=>$this->server_addr));
  }
  ...
  public function &friends_get($flid=null, $uid = null) {
    ...
    $params['server_addr']=$this->server_addr;
  ...
  public function &friends_getLists() {
    return $this->call_method('friends.getLists', array('server_addr'=>$this->server_addr));
  }
  ...
  public function &friends_getAppUsers() {
    return $this->call_method('friends.getAppUsers', array('server_addr'=>$this->server_addr));
  }

	public function &friends_getDetail($uid, $fields) {
		return $this->call_method('friends.getDetail',
		array('uid' => $uid, 'fields' => $fields,'server_addr'=>$this->server_addr));
	}
  ...
  public function &groups_get($uid, $gids) {
    return $this->call_method('groups.get',
        array('uid' => $uid,
              'gids' => $gids,'server_addr'=>$this->server_addr));
  }
  ...
  public function &groups_getMembers($gid) {
    return $this->call_method('groups.getMembers',
      array('gid' => $gid));
  }
  ...
  public function data_getCookies($uid, $name) {
    return $this->call_method('data.getCookies',
        array('uid' => $uid,
              'name' => $name));
  }
  ...
  public function data_setCookie($uid, $name, $value, $expires, $path) {
    return $this->call_method('data.setCookie',
        array('uid' => $uid,
              'name' => $name,
              'value' => $value,
              'expires' => $expires,
  ...
  public function permissions_checkGrantedApiAccess($permissions_apikey) {
    return $this->call_method('permissions.checkGrantedApiAccess',
  ...
  public function permissions_checkAvailableApiAccess($permissions_apikey) {
    return $this->call_method('permissions.checkAvailableApiAccess',
        array('permissions_apikey' => $permissions_apikey));
  }
  ...
  public function permissions_grantApiAccess($permissions_apikey, $method_arr) {
    return $this->call_method('permissions.grantApiAccess',
        array('permissions_apikey' => $permissions_apikey,
  ...
  public function permissions_revokeApiAccess($permissions_apikey) {
    return $this->call_method('permissions.revokeApiAccess',
        array('permissions_apikey' => $permissions_apikey));
  }
  ...
  public function &notifications_get() {
    return $this->call_method('notifications.get', array());
  }
  ...
  public function &notifications_send($to_ids, $notification, $type) {
    return $this->call_method('notifications.send',
        array('to_ids' => $to_ids,
              'notification' => $notification,
              'type' => $type));
  }
  
  public function &messages_sendSystem($from_uid, $to_ids, $template_name, $template_date) {
  	return $this->call_method('messages.sendSystem',
        array('sendFromUid' => $from_uid,
        	  'sendToUids' => $to_ids,
              'templateName' => $template_name,
        	  'templateData' => $template_date,
              'type' => $type,
        	  'server_addr'=>$this->server_addr));
  }
  ...
  public function &notifications_sendEmail($recipients,
                                           ...
                                           $text,
                                           $fbml) {
    return $this->call_method('notifications.sendEmail',
  ...
  public function &pages_getInfo($page_ids, $fields, $uid, $type) {
    return $this->call_method('pages.getInfo',
  ...
  public function &pages_isAdmin($page_id, $uid = null) {
    return $this->call_method('pages.isAdmin',
  ...
  public function &pages_isAppAdded($page_id) {
    return $this->call_method('pages.isAppAdded',
        array('page_id' => $page_id));
  }
  ...
  public function &pages_isFan($page_id, $uid = null) {
    return $this->call_method('pages.isFan',
        array('page_id' => $page_id,
              'uid' => $uid));
  }
   ...
   *
   *  http://wiki.developers.xiaoi.com/index.php/Photos.addTag
   *
  ...
  public function &photos_addTag($pid,
                                 ...
                                 $tags,
                                 $owner_uid=0) {
    return $this->call_method('photos.addTag',
        array('pid' => $pid,
              'tag_uid' => $tag_uid,
              'tag_text' => $tag_text,
              'x' => $x,
  ...
  public function &photos_createAlbum($name,
                                      ...
                                      $visible='',
                                      $uid=0) {
    return $this->call_method('photos.createAlbum',
        array('name' => $name,
  ...
  public function &photos_get($subj_id, $aid, $pids) {
    return $this->call_method('photos.get',
  ...
  public function &photos_getAlbums($uid, $aids) {
    return $this->call_method('photos.getAlbums',
      array('uid' => $uid,
            'aids' => $aids));
  }
  ...
  public function &photos_getTags($pids) {
    return $this->call_method('photos.getTags',
      array('pids' => $pids));
  }
  ...
  public function photos_upload($file, $aid=null, $caption=null, $uid=null) {
    return $this->call_upload_method('xiaoi.photos.upload',
                                     array('aid' => $aid,
                                           'caption' => $caption,
                                           'uid' => $uid),
                                     $file);
  ...
  public function &users_getInfo($uids, $fields) {
    return $this->call_method('users.getInfo',
        array('uids' => $uids, 'fields' => $fields,'server_addr'=>$this->server_addr));
  }
  ...
  public function &users_getStandardInfo($uids, $fields) {
    return $this->call_method('users.getStandardInfo',
        array('uids' => $uids, 'fields' => $fields,'server_addr'=>$this->server_addr));
  }
  ...
  public function &users_getLoggedInUser() {
    return $this->call_method('users.getLoggedInUser', array('server_addr'=>$this->server_addr));
  }

  /**
   * Returns 1 if the user has the specified permission, 0 otherwise.
   * http://wiki.developers.xiaoi.com/index.php/Users.hasAppPermission
   *
   * @return integer  1 or 0
   */
  public function &users_hasAppPermission($ext_perm, $uid=null) {
    return $this->call_method('users.hasAppPermission',
        array('ext_perm' => $ext_perm, 'uid' => $uid,'server_addr'=>$this->server_addr));
  }
  ...
  public function &users_isAppUser($uid=null) {
    ...
    return $this->call_method('users.isAppUser', array('uid' => $uid,'server_addr'=>$this->server_addr));
  }
  ...
  public function &users_setStatus($status,
    ...
    return $this->call_method('users.setStatus', $args);
  }
  ...
  function profile_setFBML($markup,
                           ...
                           $mobile_profile='',
                           $profile_main='') {
    return $this->call_method('profile.setFBML',
        array('markup' => $markup,
              'uid' => $uid,
              'profile' => $profile,
  ...
  public function &profile_getFBML($uid=null, $type=null) {
    return $this->call_method('profile.getFBML',
        array('uid' => $uid,
              'type' => $type));
  }
   ...
   *
   *  http://wiki.developers.xiaoi.com/index.php/Profile.getInfo
   *
   */
  public function &profile_getInfo($uid=null) {
    return $this->call_method('profile.getInfo',
        array('uid' => $uid));
  }
  ...
  public function &profile_getInfoOptions($field) {
    return $this->call_method('profile.getInfoOptions',
        array('field' => $field));
  }
   ...
   * field, please see:
   *
   *  http://wiki.developers.xiaoi.com/index.php/Profile.setInfo
   *
  ...
  public function &profile_setInfo($title, $type, $info_fields, $uid=null) {
    return $this->call_method('profile.setInfo',
        array('uid' => $uid,
              'type' => $type,
              'title'   => $title,
  ...
  public function profile_setInfoOptions($field, $options) {
    return $this->call_method('profile.setInfoOptions',
        array('field'   => $field,
  ...
  function marketplace_getCategories() {
    return $this->call_method('marketplace.getCategories',
        array());
  }
  ...
  function marketplace_getSubCategories($category) {
    return $this->call_method('marketplace.getSubCategories',
  ...
  function marketplace_getListings($listing_ids, $uids) {
    return $this->call_method('marketplace.getListings',
  ...
  function marketplace_search($category, $subcategory, $query) {
    return $this->call_method('marketplace.search',
        array('category' => $category,
  ...
  function marketplace_removeListing($listing_id,
                                     $status='DEFAULT',
                                     $uid=null) {
    return $this->call_method('marketplace.removeListing',
  ...
  function marketplace_createListing($listing_id,
                                     ...
                                     $attrs,
                                     $uid=null) {
    return $this->call_method('marketplace.createListing',
        array('listing_id' => $listing_id,
  ...
  public function &data_setUserPreference($pref_id, $value, $uid = null) {
    return $this->call_method('data.setUserPreference',
  ...
  public function &data_setUserPreferences($values,
                                           $replace = false,
                                           $uid = null) {
    return $this->call_method('data.setUserPreferences',
  ...
  public function &data_getUserPreference($pref_id, $uid = null) {
    return $this->call_method('data.getUserPreference',
       array('pref_id' => $pref_id,
             'uid' => $this->get_uid($uid)));
  }
  ...
  public function &data_getUserPreferences($uid = null) {
    return $this->call_method('data.getUserPreferences',
  ...
  public function &data_createObjectType($name) {
    return $this->call_method('data.createObjectType',
       array('name' => $name));
  }
  ...
  public function &data_dropObjectType($obj_type) {
    return $this->call_method('data.dropObjectType',
  ...
  public function &data_renameObjectType($obj_type, $new_name) {
    return $this->call_method('data.renameObjectType',
       array('obj_type' => $obj_type,
             'new_name' => $new_name));
  }
  ...
  public function &data_defineObjectProperty($obj_type,
                                             $prop_name,
                                             $prop_type) {
    return $this->call_method('data.defineObjectProperty',
       array('obj_type' => $obj_type,
             'prop_name' => $prop_name,
             'prop_type' => $prop_type));
  }
  ...
  public function &data_undefineObjectProperty($obj_type, $prop_name) {
    return $this->call_method('data.undefineObjectProperty',
       array('obj_type' => $obj_type,
             'prop_name' => $prop_name));
  }
  ...
  public function &data_renameObjectProperty($obj_type, $prop_name,
                                            $new_name) {
    return $this->call_method('data.renameObjectProperty',
       array('obj_type' => $obj_type,
             'prop_name' => $prop_name,
             'new_name' => $new_name));
  }
  ...
  public function &data_getObjectTypes() {
    return $this->call_method('data.getObjectTypes', array());
  }
  ...
  public function &data_getObjectType($obj_type) {
    return $this->call_method('data.getObjectType',
       array('obj_type' => $obj_type));
  }
  ...
  public function &data_createObject($obj_type, $properties = null) {
    return $this->call_method('data.createObject',
       array('obj_type' => $obj_type,
  ...
  public function &data_updateObject($obj_id, $properties, $replace = false) {
    return $this->call_method('data.updateObject',
       array('obj_id' => $obj_id,
             'properties' => json_encode($properties),
             'replace' => $replace));
  }
  ...
  public function &data_deleteObject($obj_id) {
    return $this->call_method('data.deleteObject',
       array('obj_id' => $obj_id));
  }
  ...
  public function &data_deleteObjects($obj_ids) {
    return $this->call_method('data.deleteObjects',
  ...
  public function &data_getObjectProperty($obj_id, $prop_name) {
    return $this->call_method('data.getObjectProperty',
       array('obj_id' => $obj_id,
             'prop_name' => $prop_name));
  }
  ...
  public function &data_getObject($obj_id, $prop_names = null) {
    return $this->call_method('data.getObject',
       array('obj_id' => $obj_id,
  ...
  public function &data_getObjects($obj_ids, $prop_names = null) {
    return $this->call_method('data.getObjects',
       array('obj_ids' => json_encode($obj_ids),
             'prop_names' => json_encode($prop_names)));
  }
  ...
  public function &data_setObjectProperty($obj_id, $prop_name,
                                         $prop_value) {
    return $this->call_method('data.setObjectProperty',
       array('obj_id' => $obj_id,
             'prop_name' => $prop_name,
  ...
  public function &data_getHashValue($obj_type, $key, $prop_name = null) {
    return $this->call_method('data.getHashValue',
       array('obj_type' => $obj_type,
             'key' => $key,
             'prop_name' => $prop_name));
  }
  ...
  public function &data_setHashValue($obj_type,
                                     ...
                                     $value,
                                     $prop_name = null) {
    return $this->call_method('data.setHashValue',
       array('obj_type' => $obj_type,
             'key' => $key,
             'value' => $value,
             'prop_name' => $prop_name));
  ...
  public function &data_incHashValue($obj_type,
                                     ...
                                     $prop_name,
                                     $increment = 1) {
    return $this->call_method('data.incHashValue',
       array('obj_type' => $obj_type,
             'key' => $key,
             'prop_name' => $prop_name,
             'increment' => $increment));
  ...
  public function &data_removeHashKey($obj_type, $key) {
    return $this->call_method('data.removeHashKey',
       array('obj_type' => $obj_type,
             'key' => $key));
  }
  ...
  public function &data_removeHashKeys($obj_type, $keys) {
    return $this->call_method('data.removeHashKeys',
       array('obj_type' => $obj_type,
  ...
  public function &data_defineAssociation($name, $assoc_type, $assoc_info1,
    ...
    return $this->call_method('data.defineAssociation',
       array('name' => $name,
  ...
  public function &data_undefineAssociation($name) {
    return $this->call_method('data.undefineAssociation',
       array('name' => $name));
  }
  ...
  public function &data_renameAssociation($name, $new_name, $new_alias1 = null,
                                         $new_alias2 = null) {
    return $this->call_method('data.renameAssociation',
       array('name' => $name,
             'new_name' => $new_name,
  ...
  public function &data_getAssociationDefinition($name) {
    return $this->call_method('data.getAssociationDefinition',
       array('name' => $name));
  }
  ...
  public function &data_getAssociationDefinitions() {
    return $this->call_method('data.getAssociationDefinitions',
       array());
  }
  ...
  public function &data_setAssociation($name, $obj_id1, $obj_id2, $data = null,
                                      $assoc_time = null) {
    return $this->call_method('data.setAssociation',
       array('name' => $name,
             'obj_id1' => $obj_id1,
             'obj_id2' => $obj_id2,
             'data' => $data,
  ...
  public function &data_setAssociations($assocs, $name = null) {
    return $this->call_method('data.setAssociations',
  ...
  public function &data_removeAssociation($name, $obj_id1, $obj_id2) {
    return $this->call_method('data.removeAssociation',
       array('name' => $name,
             'obj_id1' => $obj_id1,
             'obj_id2' => $obj_id2));
  }
  ...
  public function &data_removeAssociations($assocs, $name = null) {
    return $this->call_method('data.removeAssociations',
       array('assocs' => json_encode($assocs),
             'name' => $name));
  }
  ...
  public function &data_removeAssociatedObjects($name, $obj_id) {
    return $this->call_method('data.removeAssociatedObjects',
       array('name' => $name,
             'obj_id' => $obj_id));
  }
  ...
  public function &data_getAssociatedObjects($name, $obj_id, $no_data = true) {
    return $this->call_method('data.getAssociatedObjects',
       array('name' => $name,
             'obj_id' => $obj_id,
             'no_data' => $no_data));
  }
  ...
  public function &data_getAssociatedObjectCount($name, $obj_id) {
    return $this->call_method('data.getAssociatedObjectCount',
       array('name' => $name,
             'obj_id' => $obj_id));
  }
  ...
  public function &data_getAssociatedObjectCounts($name, $obj_ids) {
    return $this->call_method('data.getAssociatedObjectCounts',
       array('name' => $name,
  ...
  public function &data_getAssociations($obj_id1, $obj_id2, $no_data = true) {
    return $this->call_method('data.getAssociations',
  ...
  public function admin_getAppProperties($properties) {
    return json_decode(
        $this->call_method('admin.getAppProperties',
  ...
  public function admin_setAppProperties($properties) {
    return $this->call_method('admin.setAppProperties',
  ...
  public function &admin_getAllocation($integration_point_name) {
    return $this->call_method('admin.getAllocation',
   ...
   * specified by xiaoi for specifying diff age restriction for diff
   * locations.
   *
   ...
   *
   * @param string $method  Name of the Xiaoi method to invoke
   ...
   *     See: http://wiki.developers.xiaoi.com/index.php/Using_batching_API
   */
...
//                                              $result['error_code']);
  ...
  public function call_upload_method($method, $params, $file) {
    if ($this->batch_queue === null) {
      if (!file_exists($file)) {
        $code =
          XiaoiAPIErrorCodes::API_EC_PARAM;
        $description = XiaoiAPIErrorCodes::$api_error_descriptions[$code];
        throw new XiaoiRestClientException($description, $code);
      }
      ...
      $code =
        XiaoiAPIErrorCodes::API_EC_BATCH_METHOD_NOT_ALLOWED_IN_BATCH_MODE;
      $description = XiaoiAPIErrorCodes::$api_error_descriptions[$code];
      throw new XiaoiRestClientException($description, $code);
    }
...
//    print_r($params) ;
    $params['sig'] = Xiaoi::generate_sig($params, $this->secret);
  }
  ...
  public function post_request($method, $params) {
    ...
    if ($this->use_curl_if_available && function_exists('curl_init')) {
      $useragent = 'Xiaoi API PHP5 Client 1.1 (curl) ' . phpversion();
      $ch = curl_init();
      curl_setopt($ch, CURLOPT_VERBOSE, 1);
      
      curl_setopt($ch, CURLOPT_URL, $params["server_addr"]);
  ...
  private function run_http_post_transaction($content_type, $content) {
    ...
    $user_agent = 'Xiaoi API PHP5 Client 1.1 (non-curl) ' . phpversion();
...
class XiaoiRestClientException extends Exception {
}

// Supporting methods and values------

/**
 * Error codes and descriptions for the Xiaoi API.
 */

class XiaoiAPIErrorCodes {
