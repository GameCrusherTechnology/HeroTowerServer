...
class RequestFactory {
	 ...
	 *
	 * @param AppConfig $config
	 * @return TCInsertUpdateRequest
	 */
	public static function createInsertUpdateRequest(AppConfig $config){
		require_once FRAMEWORK . '/db/request/TCInsertUpdateRequest.class.php';
		return new TCInsertUpdateRequest($config);
	}
	/**
	 *
	 * @param AppConfig $config
