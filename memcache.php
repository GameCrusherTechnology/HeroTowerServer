...
//$MEMCACHE_SERVERS[] = '106.187.36.191:11211'; // add more as an array
//$MEMCACHE_SERVERS[] = '10.65.133.174:11211'; // add more as an array
//$MEMCACHE_SERVERS[] = '10.65.133.174:11212'; // add more as an array
...
if ($_GET['op']!=4){
echo <<<EOB
    <li><a href="$PHP_SELF&op=6">Refresh Data</a></li>
EOB;
}
else {
echo <<<EOB
